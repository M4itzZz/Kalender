...
<html>
<head>
<button onclick="window.location.href='index.php'" class="button">Logi välja</button>
...
<script>
 $(document).ready(function() {
  ...
  var calendar = $('#calendar').fullCalendar({
   ...
   var title = prompt('Sisetage sündmus:'); //Saab lisada sündmuse, mis ilmub pärast kalendril
